...
const DEMO_ACCOUNTS = [
  {
    ...
    username: "admin",
    password: "Admin@1234",
    label: "Principal / Registrar — St. Mary's Academy",
  },
  {
    role: "Teacher",
    ...
    label: "Ms. Aurora Aquino — Grade 7 Sampaguita",
  },
  {
    role: "Student",
    ...
    label: "Juan M. Dela Cruz — Grade 7 Sampaguita",
  },
  {
    role: "Parent",
    ...
    label: "Maria Dela Cruz — Parent of Juan & Bea",
  },
] as const;
