...
const notifications = [
  { icon: BookOpen, title: "Math 3rd Quarter grade posted", text: "Ms. Aquino posted your grade: 92 — On Track", time: "2h ago", tone: "ok" },
  { icon: CalendarCheck, title: "Attendance confirmed", text: "Time-in scanned at 7:38 AM. Have a great day!", time: "Today", tone: "ok" },
  { icon: Bell, title: "SF2 report reminder", text: "3rd Quarter SF2 will be reviewed by adviser on May 15.", time: "Yesterday", tone: "info" },
  { icon: Star, title: "Highest in class — Filipino", text: "You ranked 1st in Filipino this quarter. Congratulations!", time: "2d ago", tone: "ok" },
];
    ...
    <>
      ...
      <main className="space-y-6 p-4 sm:p-6">
        ...
        <section className="grid grid-cols-2 gap-4 lg:grid-cols-4">
          {[
            { label: "GPA This Quarter", value: currentQ3Avg.toFixed(1), hint: "3rd Quarter average", icon: BookOpen, accent: "text-chart-1" },
            { label: "Attendance Rate", value: `${myLearner.attendanceRate.toFixed(1)}%`, hint: `SF2 target ${SF2_TARGET}%`, icon: CalendarCheck, accent: isAboveTarget ? "text-chart-2" : "text-destructive" },
            { label: "Days Attended", value: "52", hint: "Out of 54 school days", icon: CheckCircle2, accent: "text-chart-2" },
            { label: "Subjects", value: subjects.length.toString(), hint: "3rd Quarter enrolled", icon: Star, accent: "text-chart-3" },
          ].map((m) => (
            ...
            <CardContent className="h-56">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={attendanceHistory}>
                  ...
                  <Line type="monotone" dataKey="rate" stroke="var(--color-chart-3)" strokeWidth={2.5} dot={{ r: 4, fill: "var(--color-chart-3)" }} activeDot={{ r: 6 }} />
                </LineChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
